// Eventos de sesión JsSIP
export const SESSION_RINGING: string = 'ringing';
export const SESSION_ANSWERED: string = 'accepted';
...
export const SESSION_ICE_READY: string = 'icecandidate';
export const SESSION_ADD_STREAM: string = 'addstream';
export const SESSION_TRACK: string = 'track';
export const SESSION_ACTIVE: string = 'confirmed';
